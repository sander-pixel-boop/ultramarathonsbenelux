...
export default function CourseProfile({ race, t }) {
    const profile = useMemo(() => {
        ...
        // ⚡ Bolt Performance Optimization: Primitive loops over array methods
        // Replaced multiple O(n) array iterations (map) and Math.max/min spread operators
        // (which risk call stack limits on large datasets) with primitive for-loops.
        // This avoids memory allocations from intermediate arrays and garbage collection spikes.
