...
cat << 'INNER_EOF' > src/app/layout.jsx
import './globals.css';

export const metadata = {
  title: 'Benelux Ultra Race Directory',
  description: 'Discover the toughest footraces and gravel events across Belgium, Netherlands, and Luxembourg.',
};
